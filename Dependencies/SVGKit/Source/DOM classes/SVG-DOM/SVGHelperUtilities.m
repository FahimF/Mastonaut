                                 ...
                                 transform:(CGAffineTransform)transform
{
    ...
    if (svgGradient == nil) {
        ...
        NSLog(@"This SVG shape has a URL fill (%@), but could not find an XML Node with that ID inside the DOM tree (suggests the parser failed, or the SVG file is corrupt)", gradId );
    }
